                                ...
                                <div class="col-md-4">
                                    <div class="mt-radio-inline">
                                        <label class="mt-radio">
                                            <input type="radio" name="enable" id="enable_1" value="1" @if ($user->enable) checked="" @endif /> Show
                                            <span></span>
                                        </label>
                                        <label class="mt-radio">
                                            <input type="radio" name="enable" id="enable_2" value="0" @if ($user->enable == 0) checked="" @endif> Hidden
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
